<link rel="stylesheet" href="<?php echo constant('URL') ?>public/css/history.css">
                ...
                <div id="filters-container">
                    ...
                    <div class="filter-container">
                        <select id="scategory" class="custom-select">
                            <option value="">Ver todos las activos</option>
            ...
            <div id="table-container">
                <table width="100%" cellpadding="0">
                    <thead>
                        ...
                        <th data-sort="category">Activo</th>
    ...
    <script>
        ...
        async function getData(){
            data = await fetch('http://localhost/feralapp/servicios/getHistoryJSON')
            .then(res =>res.json())
            .then(json => json);
            this.copydata = [...this.data];
            console.table(data);
        ...
        function renderData(data){
            ...
            data.forEach(item => { 
                ...
                databody.innerHTML += `<tr>
                        ...
                        <td>${item.date}</td>
                        <td>$${item.amount}</td>
                        <td><a href="http://localhost/feralapp/servicios/delete/${item.id}">Eliminar</a></td>
                    </tr>`;
            });
        }
